    ...
    override fun onClick(v: View) {
       when (v.id){
           ...
           R.id.btn_move_activity_data -> {
            ...
            moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Sectio Kautsar Ramadhani")
            moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 15)
            startActivity(moveWithDataIntent)
           }
           R.id.btn_move_with_object -> {
               val person = Person(
                   "Sectio Kautsar Ramadhani",
                   15,
                   "ramadhani2910712@gmail.com",
                   "Rawalo"
               )
